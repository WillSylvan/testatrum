...
=======
  ...
  <style>
    input:disabled {
>>>>>>> 7fe88cf8da38d8adcb3f7a525fd6d329ecf17c56
...
<<<<<<< HEAD
        ...
        <form id="one-form" action="javascript:void(0)">
          <div><input name="name" id="name" class="input inputError" placeholder="Vārds, Uzvārds" pattern="[a-zA-Z]+[ ][a-zA-Z]+" value="" onclick="function()" onblur="checkk($(this))"></div>
          <div><input name="p_code" id="p_code" class="input" placeholder="Personas kods" data-mask="00-00" pattern="[0-9]{6}[-]{1}[0-9]{5}" onblur="checkk($(this))"></div>
          <div class="flex info">
            <div><input name="phone" id="phone" class="input" placeholder="Tel." pattern="[0-9]{8}" onblur="checkk($(this))"></div>
            <div><input name="e_mail" id="email" class="input" placeholder="Epasts:" pattern="[a-zA-Z0-9]+[@]{1}[a-zA-Z0-9]+[.]{1}[a-z]+" onblur="checkk($(this))"></div>
          </div>
          <div><input name="place_of_job" id="place_of_job" class="input" placeholder="Darba vieta:" onblur="checkk($(this))"></div>
          <div><input name="position" id="position" class="input" placeholder="Ieņemamais amats" onblur="checkk($(this))"></div>
          <div><input name="m_income" id="m_income" class="input" placeholder="Ikmēneša ienākumi:" onblur="checkk($(this))"></div>
          <div><input name="m_expenses" id="m_expenses" class="input" placeholder="Ikmēneša izdevumi:" onblur="checkk($(this))"></div>

          <div><input class="turpinat passing-unavailable" type="submit" value="Turpināt"></div>
=======
