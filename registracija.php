		...
		<div id="page-form-content">
			...
			<div id="form-1" style="display: block;">
				...
				<form id="one-form" action="javascript:void(0)">
					<div><input name="name" id="name" class="input" placeholder="Vārds, Uzvārds" value="" onclick="function()" onblur="checkk($(this))"></div>
					<div><input name="p_code" id="p_code" class="input" placeholder="Personas kods" data-mask="000000-00000" onblur="checkk($(this))"></div>
					<div class="flex info">
						<div><input name="phone" id="phone" class="input" placeholder="Tel." onblur="checkk($(this))"></div>
						<div><input name="e_mail" id="email" class="input" placeholder="Epasts:" onblur="checkk($(this))"></div>
					</div>
