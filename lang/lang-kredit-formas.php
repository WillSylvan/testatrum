<?php 
    ...
    $language['lv']['credit-head-long'] = 'Kredīts līdz 1000 EUR ar atmaksas termiņu 3-12 mēneši';
    $language['ru']['credit-head-long'] = 'Кредит до 1000 евро со сроком отплаты 3-12 месяцев';

    $language['lv']['credit-head-short'] = 'Pirmais kredīts līdz 300 EUR ar 0% komisijas maksu';
    $language['ru']['credit-head-short'] = 'Первый кредит до 300 евро с комиссионной платой 0%';

    $language['lv']['days'] = 'Dienas: ';
    $language['ru']['days'] = 'Дни: ';

    $language['lv']['monthly-pay'] = 'Ikmēneša maksājums';
    $language['lv']['monthly-pay'] = 'Ежемесячный платёж';

    $language['lv']['paymentGraf'] = 'Maksājumu grafiks';
    $language['ru']['paymentGraf'] = 'График платежей';


    $language['lv']['paymentDate'] = 'maksājuma datums';
    $language['ru']['paymentDate'] = 'дата  платежей';

    $language['lv']['paymentMonthly'] = 'ikmēneša maksājums';
    $language['ru']['paymentMonthly'] = 'ежемесячная плата';

    $language['lv']['nr'] = 'nr.';
    $language['ru']['nr'] = 'нр.';

    $language['lv']['getloan'] = 'saņemt kredītu';
    $language['ru']['getloan'] = 'получить кредит';
?>   