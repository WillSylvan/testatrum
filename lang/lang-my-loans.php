<?php 
	...
	$language['lv']['shorttremloan'] = '<span>Īstermiņa</span> kredīti';
	$language['lv']['longtremloan'] = '<span>Ilgremiņa</span> kredīti';

	$language['ru']['shorttremloan'] = '<span>Краткосрочный</span>  кредит';
