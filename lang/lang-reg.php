...
// ------------------------------------------------------------------------------>
    ...
    $language['lv']['new-client'] = 'Jauns klients ';
    $language['ru']['new-client'] = 'Новый клиент';

    $language['lv']['exist-client'] = 'Esošs klients';
    $language['ru']['exist-client'] = 'уществующий клиент';
    ...
    $language['lv']['a-long-pay'] = 'Pilsēta';
    $language['ru']['a-long-pay'] = 'Город';
